...
function Login() {
    ...
    return (
        <div className='flex justify-center items-center h-screen px-4 sm:px-6 lg:px-8' style={{ backgroundImage: `url(${backgroundImageUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            {loading && <Loader />}
            <div className='bg-gray-800 px-6 py-8 sm:px-10 sm:py-10 rounded-xl relative w-full max-w-sm'>
                <button
                    onClick={handleClose}
                    className='absolute top-2 right-2 text-white cursor-pointer hover:text-gray-300'
                >
                ...
                <div className='flex justify-center mb-3'>
                    <button
                        onClick={login}
                        className='bg-yellow-500 w-full text-black font-bold px-3 py-2 rounded-lg'>
                        Login
                    </button>
                </div>
                <div>
