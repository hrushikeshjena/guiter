                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            <Transition.Child
                                ...
                                leaveTo="opacity-0 scale-95"
                            >
                                <Dialog.Panel className="w-full max-w-lg sm:max-w-md transform overflow-hidden rounded-2xl p-4 text-left align-middle shadow-xl transition-all bg-gray-50">
                                    <section>
                                            ...
                                            <div className="w-full rounded-lg">
                                                <div className="p-6 space-y-4 md:space-y-6">
                                                    ...
                                                    <button 
                                                        ...
                                                        type="button" 
                                                        className="w-full text-white bg-violet-600 hover:bg-violet-800 rounded-lg text-sm px-5 py-2.5"
                                                    >
                                                        Order Now
                                                    </button>
                                                </div>
